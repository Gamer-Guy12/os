...
gdt_pointer_t create_descriptors(void) {
  ...
  // Kernel Data
  gdt[2].access_byte = GDT_ACCESS_PRESENT | GDT_ACCESS_DESCRIPTOR | GDT_ACCESS_READ_WRITE;
  ...
  // User Data
  gdt[4].access_byte = GDT_ACCESS_PRESENT | GDT_ACCESS_DESCRIPTOR | (3 << 5) | GDT_ACCESS_READ_WRITE;
